...
void printVote(){
  ...
  //  extractInformation();
    printf("\n\n\n-------------------------------------------------------------------\n\n\n");
    printf("\n\n\n\nCongrats!  Voter ID: %d!  Your poll has successfully saved!\n",*switches);
